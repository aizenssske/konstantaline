    ...
    <>
      ...
      <section className="settings-grid">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <article className="card info-card"><h3>Joylashtirish</h3><div className="info-list"><div><span>Web ilova</span><strong>Vercel</strong></div><div><span>Telegram bot</span><strong>Render</strong></div><div><span>Ma’lumotlar</span><strong>Neon PostgreSQL</strong></div></div></article>
        </div>
      </section>
